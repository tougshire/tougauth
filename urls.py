...
urlpatterns = [
    ...
    path('password_change/done/', auth_views.PasswordChangeView.as_view(template_name='tougshire_auth/password_change_done.html'), name='password_change_done'),
    ...
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='tougshire_auth/password_reset_complete.html'), name='password_reset_complete'),
]
